...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.points'
        db.delete_column(u'common_collection', 'points')


    def backwards(self, orm):
        # Adding field 'Collection.points'
        db.add_column(u'common_collection', 'points',
                      self.gf('django.contrib.gis.db.models.fields.MultiPointField')(default='POINT(0 0)'),
                      keep_default=False)
